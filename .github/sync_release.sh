...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-TankBattalion_MiSTer.git"
CORE_NAME=(Arcade-TankBattalion)
...
UPSTREAM_CORE_NAME=(Arcade-TankBattalion)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-TankBattalion.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-TankBattalion.rbf)
